...
export const Hero: React.FC<HeroProps> = ({ lang, onOpenGiving, onOpenAI }) => {
  const heroImgUrl = "/src/assets/images/canaan_church_hero_1786434083190.jpg";
  ...
  return (
    <section className="relative min-h-[90vh] pt-32 pb-20 md:pt-36 md:pb-28 flex items-center bg-slate-950 overflow-hidden text-white">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroImgUrl} 
          alt="Canaan New Life Christian Church Sanctuary" 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="space-y-3">
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.15]">
              {lang === 'zh' ? (
                ...
                <>
                  Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-300 to-amber-100">Canaan New Life</span>
                </>
              )}
            </h1>
          ...
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl font-light">
            {lang === 'zh' 
              ? '加南新生基督教會 (Canaan New Life Christian Church) 位於加州 Harbor City。我們竭誠歡迎您與家人參加每週日早上 11:00 的主日崇拜，感受上帝屬天更新的平安與溫馨家園！'
              : 'Located in Harbor City, CA, Canaan New Life Christian Church warmly invites you and your family to worship with us every Sunday at 11:00 AM.'
            }
          </p>
