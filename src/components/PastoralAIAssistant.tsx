...
export const PastoralAIAssistant: React.FC<PastoralAIProps> = ({ lang, isOpen, onClose }) => {
  ...
  const [messages, setMessages] = useState<Array<{ role: 'user' | 'ai'; text: string }>>([
    {
      ...
      text: lang === 'zh'
        ...
        : "Peace be with you! I am Canaan New Life Christian Church's AI Bible & Prayer Companion. How may I encourage you with Scripture or prayer today?"
    }
  ]);
  ...
  const quickPrompts = lang === 'zh' ? [
    ...
    "What are Canaan New Life Church service times?"
  ];
  ...
  const handleSend = async (userText?: string) => {
    ...
    try {
      ...
      setMessages([...newMsgs, { role: 'ai', text: data.reply || 'May God bless you!' }]);
    } catch (err) {
