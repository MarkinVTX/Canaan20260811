      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-amber-100 text-amber-900 text-xs font-semibold uppercase tracking-wider">
            ...
            <span>{lang === 'zh' ? '關於加南新生基督教會' : 'About Canaan New Life'}</span>
          </div>
          ...
          <p className="text-slate-600 text-base leading-relaxed">
            {lang === 'zh' 
              ? '加南新生基督教會 (Canaan New Life Christian Church) 創立於 1984 年，為獨立基督教會 (Independent Christian Church)。四十多年來在 Harbor City 忠心敬拜神、培育信徒、廣傳福音。'
              : 'Established in 1984 as an independent Christian church, Canaan New Life Christian Church serves the South Bay community with faithful Bible preaching and warm fellowship.'}
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm">
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden border-4 border-amber-50 shadow-md aspect-4/3 sm:aspect-square bg-slate-100">
                <img 
                  src="/src/assets/images/canaan_fellowship_1786434097997.jpg" 
                  alt="Canaan New Life Church Community" 
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="space-y-2">
                ...
                <h3 className="font-serif text-2xl sm:text-3xl font-bold text-slate-900">
                  {lang === 'zh' ? '加南新生基督教會 長執同工會' : 'Canaan New Life Leadership Board'}
                </h3>
              </div>
              ...
              <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
                <p>
                  {lang === 'zh'
                    ? '加南新生基督教會 (Canaan New Life Christian Church) 自1984年創立以來，始終秉持聖經真理，致力於建造健全屬靈生命。我們擁有豐富的主日學教導、聖歌隊獻詩、週四線上禱告會以及溫馨團契愛宴。'
                    : 'Since 1984, Canaan New Life Christian Church has been dedicated to biblical teaching, choir worship, vibrant prayer meetings, and warm multi-generational community fellowship in Harbor City, CA.'
                  }
                </p>
                <p>
                  {lang === 'zh'
