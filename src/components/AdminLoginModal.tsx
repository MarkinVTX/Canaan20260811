        ...
        <div className="p-6 space-y-5">
          <div className="p-3 bg-amber-50 border border-amber-200 rounded-2xl text-xs text-amber-900 space-y-1">
            <div className="font-bold flex items-center space-x-1.5">
              ...
              <span>{lang === 'zh' ? '週報更新權限驗證' : 'Bulletin Sync Verification'}</span>
            </div>
            <p>
              {lang === 'zh'
                ? '請使用 web@canaannewlife.org 登入以啟用「週報 PDF 上傳」與「Email 自動更新」管理功能。'
                : 'Log in with web@canaannewlife.org to enable PDF bulletin upload and email auto-update controls.'}
            </p>
          </div>
